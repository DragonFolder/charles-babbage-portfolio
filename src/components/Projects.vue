<template>
    <section class="pb-5" id="projects">
        ...
        <!-- Let's implement map method so that we can show all the projects thru using the ProjectCard component -->
        <div
...
<script setup>
	...
	// this function is responsible for splitting the projects array into smaller arrays(chunks) with 3 elements per array
